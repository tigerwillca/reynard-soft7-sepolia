...
`index.html` is the public landing: Mask Depth Reynard hero (`soft7-mascot-hero.jpg`), a full-page forest loop (`soft7-bg-loop.webm` / `.mp4`, poster `soft7-bg-key-01.png`), and the Seventh Gate link orb. Card art is `images/033.jpg`–`images/039.jpg`. Token metadata is `meta/1.json`–`meta/7.json`.
